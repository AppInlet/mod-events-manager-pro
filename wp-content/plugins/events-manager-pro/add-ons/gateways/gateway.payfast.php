 ...
 * gateway.payfast.php
 *
 * Copyright (c) 2009-2015 PayFast (Pty) Ltd
 * 
 * LICENSE:
 * 
 ...
 * @copyright  2009-2015 PayFast (Pty) Ltd
...
class EM_Gateway_PayFast extends EM_Gateway
{
    ...
    function get_payfast_vars( $EM_Booking )
    {
        ...
        $payfast_vars = array(
            'merchant_id' => get_option( 'em_'. $this->gateway . "_status" ) == 'test' ? '10000100' : get_option( 'em_' . $this->gateway . "_merchant_id" ),
            'merchant_key' => get_option( 'em_'. $this->gateway . "_status" ) == 'test' ? '46f0cd694581a' : get_option( 'em_' . $this->gateway . "_merchant_key" ),
        ...
        if( empty( $passPhrase ) ||  get_option('em_'. $this->gateway . "_status") == 'test' )
        {
